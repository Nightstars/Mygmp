...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("\n", f);
  fputs ("relink_command=\"(cd /home/Administrator/gmp-6.2.0/tests/mpf; { test -z \\\"\\${LIB", f);
  ...
  fputs ("ntic -fomit-frame-pointer -m64 -mtune=k8 -march=k8 -o @OUTPUT@ t-get_d_2exp.o  ", f);
