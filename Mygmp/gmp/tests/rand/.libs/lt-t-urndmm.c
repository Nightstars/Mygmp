...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("\n", f);
  fputs ("relink_command=\"(cd /home/Administrator/gmp-6.2.0/tests/rand; { test -z \\\"\\${LI", f);
  fputs ("BRARY_PATH+set}\\\" || unset LIBRARY_PATH || { LIBRARY_PATH=; export LIBRARY_PATH", f);
  fputs ("; }; }; { test -z \\\"\\${COMPILER_PATH+set}\\\" || unset COMPILER_PATH || { COMPILE", f);
  fputs ("R_PATH=; export COMPILER_PATH; }; }; { test -z \\\"\\${GCC_EXEC_PREFIX+set}\\\" || u", f);
  fputs ("nset GCC_EXEC_PREFIX || { GCC_EXEC_PREFIX=; export GCC_EXEC_PREFIX; }; }; { tes", f);
  fputs ("t -z \\\"\\${LD_RUN_PATH+set}\\\" || unset LD_RUN_PATH || { LD_RUN_PATH=; export LD_", f);
  fputs ("RUN_PATH; }; }; PATH=/mingw64/bin:/usr/local/bin:/usr/bin:/usr/bin:/c/Windows/S", f);
  fputs ("ystem32:/c/Windows:/c/Windows/System32/Wbem:/c/Windows/System32/WindowsPowerShe", f);
  fputs ("ll/v1.0:/usr/bin/site_perl:/usr/bin/vendor_perl:/usr/bin/core_perl; export PATH", f);
  fputs ("; PATH=/mingw64/bin:/usr/local/bin:/usr/bin:/usr/bin:/c/Windows/System32:/c/Win", f);
  fputs ("dows:/c/Windows/System32/Wbem:/c/Windows/System32/WindowsPowerShell/v1.0:/usr/b", f);
  fputs ("in/site_perl:/usr/bin/vendor_perl:/usr/bin/core_perl; export PATH; gcc -O2 -ped", f);
  fputs ("antic -fomit-frame-pointer -m64 -mtune=k8 -march=k8 -o @OUTPUT@ t-urndmm.o  ../", f);
  fputs ("../tests/.libs/libtests.a -L/mingw64/lib -lgmp -L/mingw64/lib)\"\n", f);
  fputs ("\n", f);
