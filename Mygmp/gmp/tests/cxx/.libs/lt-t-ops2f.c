...
/* ./.libs/lt-t-ops2f.c - temporary wrapper executable for .libs/t-ops2f.exe
   Generated by libtool (GNU libtool) 2.4.6

   The t-ops2f program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "t-ops2f.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# t-ops2f - temporary wrapper script for .libs/t-ops2f.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The t-ops2f program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("T@ t-ops2f.o  -L../../.libs ../../tests/.libs/libtests.a -L/mingw64/lib -lgmpxx", f);
  fputs (" -lgmp -L/mingw64/lib)\"\n", f);
  fputs ("\n", f);
  ...
  fputs ("    echo \"t-ops2f.exe:t-ops2f:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&", f);
  fputs ("2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"t-ops2f.exe:t-ops2f:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"t-ops2f.exe:t-ops2f:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
