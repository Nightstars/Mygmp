...
/* ./.libs/lt-t-ops2qf.c - temporary wrapper executable for .libs/t-ops2qf.exe
   Generated by libtool (GNU libtool) 2.4.6

   The t-ops2qf program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "t-ops2qf.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# t-ops2qf - temporary wrapper script for .libs/t-ops2qf.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The t-ops2qf program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("\n", f);
  fputs ("relink_command=\"(cd /home/Administrator/gmp-6.2.0/tests/cxx; { test -z \\\"\\${LIB", f);
  ...
  fputs ("n/site_perl:/usr/bin/vendor_perl:/usr/bin/core_perl; export PATH; x86_64-w64-mi", f);
  fputs ("ngw32-g++ -O2 -pedantic -fomit-frame-pointer -m64 -mtune=k8 -march=k8 -o @OUTPU", f);
  fputs ("T@ t-ops2qf.o  -L../../.libs ../../tests/.libs/libtests.a -L/mingw64/lib -lgmpx", f);
  fputs ("x -lgmp -L/mingw64/lib)\"\n", f);
  fputs ("\n", f);
  ...
  fputs ("  notinst_deplibs=' ../../libgmpxx.la /home/Administrator/gmp-6.2.0/libgmp.la .", f);
  fputs ("./../libgmp.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"t-ops2qf.exe:t-ops2qf:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1", f);
  fputs (">&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"t-ops2qf.exe:t-ops2qf:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"t-ops2qf.exe:t-ops2qf:$LINENO: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
