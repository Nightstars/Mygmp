...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("\n", f);
  fputs ("relink_command=\"(cd /home/Administrator/gmp-6.2.0/tests; { test -z \\\"\\${LIBRARY", f);
  fputs ("_PATH+set}\\\" || unset LIBRARY_PATH || { LIBRARY_PATH=; export LIBRARY_PATH; }; ", f);
  fputs ("}; { test -z \\\"\\${COMPILER_PATH+set}\\\" || unset COMPILER_PATH || { COMPILER_PAT", f);
  fputs ("H=; export COMPILER_PATH; }; }; { test -z \\\"\\${GCC_EXEC_PREFIX+set}\\\" || unset ", f);
  fputs ("GCC_EXEC_PREFIX || { GCC_EXEC_PREFIX=; export GCC_EXEC_PREFIX; }; }; { test -z ", f);
  fputs ("\\\"\\${LD_RUN_PATH+set}\\\" || unset LD_RUN_PATH || { LD_RUN_PATH=; export LD_RUN_P", f);
  fputs ("ATH; }; }; PATH=/mingw64/bin:/usr/local/bin:/usr/bin:/usr/bin:/c/Windows/System", f);
  fputs ("32:/c/Windows:/c/Windows/System32/Wbem:/c/Windows/System32/WindowsPowerShell/v1", f);
  fputs (".0:/usr/bin/site_perl:/usr/bin/vendor_perl:/usr/bin/core_perl; export PATH; PAT", f);
  fputs ("H=/mingw64/bin:/usr/local/bin:/usr/bin:/usr/bin:/c/Windows/System32:/c/Windows:", f);
  fputs ("/c/Windows/System32/Wbem:/c/Windows/System32/WindowsPowerShell/v1.0:/usr/bin/si", f);
  fputs ("te_perl:/usr/bin/vendor_perl:/usr/bin/core_perl; export PATH; gcc -O2 -pedantic", f);
  fputs (" -fomit-frame-pointer -m64 -mtune=k8 -march=k8 -o @OUTPUT@ t-hightomask.o  ./.l", f);
  fputs ("ibs/libtests.a -L/mingw64/lib -lgmp -L/mingw64/lib)\"\n", f);
  fputs ("\n", f);
