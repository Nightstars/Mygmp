...
/* ./.libs/lt-t-lucm.c - temporary wrapper executable for .libs/t-lucm.exe
   Generated by libtool (GNU libtool) 2.4.6

   The t-lucm program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "t-lucm.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# t-lucm - temporary wrapper script for .libs/t-lucm.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The t-lucm program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("ntic -fomit-frame-pointer -m64 -mtune=k8 -march=k8 -o @OUTPUT@ t-lucm.o  ../../", f);
  ...
  fputs ("    echo \"t-lucm.exe:t-lucm:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"t-lucm.exe:t-lucm:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"t-lucm.exe:t-lucm:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
