...
/* ./.libs/lt-t-gcdext_1.c - temporary wrapper executable for .libs/t-gcdext_1.exe
   Generated by libtool (GNU libtool) 2.4.6

   The t-gcdext_1 program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "t-gcdext_1.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# t-gcdext_1 - temporary wrapper script for .libs/t-gcdext_1.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The t-gcdext_1 program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("\n", f);
  fputs ("relink_command=\"(cd /home/Administrator/gmp-6.2.0/tests/mpn; { test -z \\\"\\${LIB", f);
  ...
  fputs ("ntic -fomit-frame-pointer -m64 -mtune=k8 -march=k8 -o @OUTPUT@ t-gcdext_1.o  ..", f);
  ...
  fputs ("    echo \"t-gcdext_1.exe:t-gcdext_1:$LINENO: libtool wrapper (GNU libtool) 2.4.", f);
  fputs ("6\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"t-gcdext_1.exe:t-gcdext_1:$LINENO: newargv[$lt_dump_args_N]: $lt_arg", f);
  fputs ("\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"t-gcdext_1.exe:t-gcdext_1:$LINENO: newargv[0]: $progdir/$program", f);
  fputs ("\" 1>&2\n", f);
