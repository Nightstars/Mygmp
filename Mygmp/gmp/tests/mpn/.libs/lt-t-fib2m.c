...
/* ./.libs/lt-t-fib2m.c - temporary wrapper executable for .libs/t-fib2m.exe
   Generated by libtool (GNU libtool) 2.4.6

   The t-fib2m program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "t-fib2m.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# t-fib2m - temporary wrapper script for .libs/t-fib2m.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The t-fib2m program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("ntic -fomit-frame-pointer -m64 -mtune=k8 -march=k8 -o @OUTPUT@ t-fib2m.o  ../..", f);
  ...
  fputs ("    echo \"t-fib2m.exe:t-fib2m:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&", f);
  fputs ("2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"t-fib2m.exe:t-fib2m:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"t-fib2m.exe:t-fib2m:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
